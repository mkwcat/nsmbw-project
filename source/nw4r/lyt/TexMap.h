...
public:
    ...
    void* GetImage() const { return mpImage; }
    ...
    void* GetPalette() const { return mpPalette; }
    ...
    void SetPaletteEntryNum(
        u16 num
    ) {
        mPaletteEntryNum = num;
    }

    GXTexFmt GetTexelFormat() const { return GXTexFmt(mBits.textureFormat); }
    ...
    bool IsMipMap() const { return mBits.mipmap; }
    ...
    GXTexWrapMode GetWrapModeS() const { return static_cast<GXTexWrapMode>(mBits.wrapS); }

    GXTexWrapMode GetWrapModeT() const { return static_cast<GXTexWrapMode>(mBits.wrapT); }
    ...
    GXTexFilter GetMinFilter() const { return static_cast<GXTexFilter>(mBits.minFilter); }

    GXTexFilter GetMagFilter() const { return static_cast<GXTexFilter>(mBits.magFilter); }

    void SetFilter(
        GXTexFilter minFlt, GXTexFilter magFlt
    ) {
        mBits.minFilter = static_cast<u32>(minFlt);
        mBits.magFilter = static_cast<u32>(magFlt);
    }

    bool IsBiasClampEnable() const { return mBits.biasClampEnable; }
    ...
    bool IsEdgeLODEnable() const { return mBits.edgeLODEnable; }

    void SetEdgeLODEnable(
        bool b
    ) {
        mBits.edgeLODEnable = b;
    }

    GXAnisotropy GetAnisotropy() const { return static_cast<GXAnisotropy>(mBits.anisotropy); }
    ...
    GXTlutFmt GetPaletteFormat() const { return static_cast<GXTlutFmt>(mBits.paletteFormat); }
