...
void ScnObj::CheckCallback_CALC_VIEW(Timing timing, u32 param_2, void* param_3)
{
...
void ScnObj::CheckCallback_CALC_MAT(Timing timing, u32 param_2, void* param_3)
{
    if (mCallback != nullptr) {
...
void ScnObj::CheckCallback_CALC_WORLD(Timing timing, u32 param_2, void* param_3)
{
    if (mCallback != nullptr) {
...
public:
    ScnLeaf(MEMAllocator* allocator)
      : ScnObj(allocator)
