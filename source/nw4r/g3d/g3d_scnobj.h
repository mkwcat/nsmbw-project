...
public:
    ...
    IScnObjCallback* GetScnObjCallback() { return mCallback; }

    const math::MTX34* GetMtxPtr(
        ScnObjMtxType type
    ) const {
    ...
    inline void CheckCallback_CALC_VIEW(Timing timing, u32 param_2, void* param_3);
    inline void CheckCallback_CALC_MAT(Timing timing, u32 param_2, void* param_3);
    inline void CheckCallback_CALC_WORLD(Timing timing, u32 param_2, void* param_3);

    bool IsG3dProcDisabled(
        u32 task
    ) const {
...
struct IScnObjCallback {
    ...
    virtual void ExecCallback_DRAW_XLU(
        ScnObj::Timing, ScnObj*, u32, void*
    ) {} // at 0x1C
};

// Is there a better way of resolving this dependency?
void ScnObj::CheckCallback_CALC_VIEW(
    Timing timing, u32 param_2, void* param_3
) {
    if (mCallback != nullptr) {
        if ((mExecOp & EXEC_OP_4) && (mTiming & timing)) {
            mCallback->ExecCallback_CALC_VIEW(timing, this, param_2, param_3);
        }
    }
}

void ScnObj::CheckCallback_CALC_MAT(
    Timing timing, u32 param_2, void* param_3
) {
    if (mCallback != nullptr) {
        if ((mExecOp & EXEC_OP_2) && (mTiming & timing)) {
            mCallback->ExecCallback_CALC_MAT(timing, this, param_2, param_3);
        }
    }
}

void ScnObj::CheckCallback_CALC_WORLD(
    Timing timing, u32 param_2, void* param_3
) {
    if (mCallback != nullptr) {
        if ((mExecOp & EXEC_OP_1) && (mTiming & timing)) {
            mCallback->ExecCallback_CALC_WORLD(timing, this, param_2, param_3);
        }
    }
}
