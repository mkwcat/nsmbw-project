...
struct ResAnmTexSrt {
    ...
    inline ResAnmTexSrtData& ref() const { return mAnmTexSrt.ref(); }

    inline bool CheckRevision() const { return mAnmTexSrt.ref().mRevision == REVISION; }

    inline const ResAnmTexSrtMatData* GetMatAnm(
        u32 i
    ) const {
