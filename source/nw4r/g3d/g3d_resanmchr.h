...
struct ResAnmChr {
    ...
    inline bool CheckRevision() const { return mAnmChr.ref().mRevision == REVISION; }

    AnmPolicy GetAnmPolicy() const { return mAnmChr.ref().mAnmPolicy; }

    int GetNumFrame() const { return mAnmChr.ref().mNumFrames; }
};
} // namespace g3d
} // namespace nw4r
