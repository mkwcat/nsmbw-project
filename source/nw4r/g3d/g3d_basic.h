...
inline bool IsScaleOne(
    u32 flags
) {
    return (flags & 0x40000000);
}

inline u32 AnmScaleOne(
    u32 flags
) {
    return (flags | 0x40000000);
}

inline u32 AnmNotScaleOne(
    u32 flags
) {
    return (flags & 0x3fffffff);
}

inline u32 AnmScaleUniform(
    u32 flags
) {
    return (flags | 0x10000000);
}

inline u32 AnmNotScaleUniform(
    u32 flags
) {
...
u32 CalcWorldMtx_Basic(
    math::MTX34*, math::VEC3*, const math::MTX34*, const math::VEC3*, u32, const ChrAnmResult*
);
}
} // namespace detail
} // namespace g3d
