...
/* 8007BFA4 C0028C90 */  lfs      f0, -29552(r2);
...
/* 8007BFF8 C0428CEC */  lfs      f2, -29460(r2);
/* 8007BFFC 7FE3FB78 */  mr       r3, r31;
/* 8007C000 C0228CF0 */  lfs      f1, -29456(r2);
/* 8007C004 C0028C90 */  lfs      f0, -29552(r2);
...
/* 8007C038 C0028DB8 */  lfs      f0, -29256(r2);
...
/* 8007C05C C0028CDC */  lfs      f0, -29476(r2);
...
UNDEF_8007c0f0:;
/* 8007C0F0 C0228C90 */  lfs      f1, -29552(r2);
/* 8007C0F4 3C9F0009 */  addis    r4, r31, 9;
/* 8007C0F8 C0628C98 */  lfs      f3, -29544(r2);
/* 8007C0FC 38A00000 */  li       r5, 0;
/* 8007C100 C0428DBC */  lfs      f2, -29252(r2);
...
/* 8007C250 C0228C90 */  lfs      f1, -29552(r2);
...
/* 8007C358 C0228C90 */  lfs      f1, -29552(r2);
...
/* 8007C5B8 C0028C90 */  lfs      f0, -29552(r2);
...
/* 8007C6CC C0028C90 */  lfs      f0, -29552(r2);
...
/* 8007C778 C0028C98 */  lfs      f0, -29544(r2);
