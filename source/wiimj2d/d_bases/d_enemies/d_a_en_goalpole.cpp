...
/* 80A0AD20 90A30A40 */  stw      r5, daEnGlpole_c_OFFSET_mPlayerPos + 0x8(r3);
/* 80A0AD24 801B0A9C */  lwz      r0, 2716(r27);
/* 80A0AD28 54002036 */  slwi     r0, r0, 4;
/* 80A0AD2C 7C7B0214 */  add      r3, r27, r0;
/* 80A0AD30 98830A45 */  stb      r4, daEnGlpole_c_OFFSET_mPlayerPos + 0xD(r3);
...
/* 80A0AD58 98830A45 */  stb      r4, daEnGlpole_c_OFFSET_mPlayerPos + 0xD(r3);
UNDEF_80a0ad5c:;
...
[[nsmbw(0x80A0A9F0)]]
void daEnGlpole_c::FUN_80A0A9F0() ASM_METHOD(
/* 80A0A9F0 9421FFE0 */  stwu     r1, -32(r1);
/* 80A0A9F4 39400000 */  li       r10, 0;
/* 80A0A9F8 38000003 */  li       r0, 3;
UNDEF_80a0aa00:;
/* 80A0AA00          */  addi     r8, r3, daEnGlpole_c_OFFSET_mPlayerPos - 0x438;
...
UNDEF_80a0aac0:;
/* 80A0AAC0 C0250A3C */  lfs      f1, daEnGlpole_c_OFFSET_mPlayerPos + 0x4(r5);
/* 80A0AAC4 FC010000 */  fcmpu    cr0, f1, f0;
/* 80A0AAC8 41820028 */  beq-     UNDEF_80a0aaf0;
/* 80A0AACC 88050A45 */  lbz      r0, daEnGlpole_c_OFFSET_mPlayerPos + 0xD(r5);
...
/* 80A0AAE8 98A40A45 */  stb      r5, daEnGlpole_c_OFFSET_mPlayerPos + 0xD(r4);
