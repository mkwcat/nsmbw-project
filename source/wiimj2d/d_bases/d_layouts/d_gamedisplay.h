...
class dGameDisplay_c : public dBase_c {
    // Original size: 0x5A4
    VTABLE(0x060, fBase_c, 0x80327A38);
    // 0x80327668 g_profile_GAMEDISPLAY
    // 0x80157820 dGameDisplay_c_classInit
...
public:
    ...
    /*
     * initializeState: 0x80158F50
     * executeState:    0x80158F70
     * finalizeState:   0x80158FE0
     */
    sState_Extern(0x80377378, dGameDisplay_c, ProcMainGame);

    /*
     * initializeState: 0x80158FF0
     * executeState:    0x80159010
     * finalizeState:   0x80159040
     */
    sState_Extern(0x803773B8, dGameDisplay_c, ProcMainPause);

    /*
     * initializeState: 0x80159050
     * executeState:    0x801590B0
     * finalizeState:   0x80159190
     */
    sState_Extern(0x803773F8, dGameDisplay_c, ProcGoalSettleUp);

    /*
     * initializeState: 0x801591A0
     * executeState:    0x801591B0
     * finalizeState:   0x801591E0
     */
