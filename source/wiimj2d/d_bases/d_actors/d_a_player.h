...
class dAcPy_c : public daPlBase_c, public dProf::Info<dAcPy_c, dProf::PLAYER> {
    SIZE_ASSERT(0x2D08);
    VTABLE(0x0060, fBase_c, 0x80325768);
    // 0x8032567C g_profile_PLAYER
    // 0x801443C0 dAcPy_c_classInit
...
public:
    ...
    /*
     * initializeState: VT+0x2A4 0x8012CCE0
     * executeState:    VT+0x2A8 0x8012CE10
     * finalizeState:   VT+0x2AC 0x8012CF80
     */
    sState_ExternVirtual(0x80375F2C, dAcPy_c, Walk);

    /*
     * initializeState: VT+0x2B0 0x801272B0
     * executeState:    VT+0x2B4 0x80127480
     * finalizeState:   VT+0x2B8 0x80127380
     */
    sState_ExternVirtual(0x80375F6C, dAcPy_c, Jump);

    /*
     * initializeState: VT+0x2C8 0x80127080
     * executeState:    VT+0x2CC 0x80127230
     * finalizeState:   VT+0x2D0 0x80127190
     */
    sState_ExternVirtual(0x80375FAC, dAcPy_c, Fall);

    /*
     * initializeState: VT+0x2D4 0x80128360
     * executeState:    VT+0x2D8 0x801284B0
     * finalizeState:   VT+0x2DC 0x80128420
     */
    sState_ExternVirtual(0x80375FEC, dAcPy_c, Land);

    /*
     * initializeState: VT+0x2E0 0x8012D760
     * executeState:    VT+0x2E4 0x8012DBA0
     * finalizeState:   VT+0x2E8 0x8012D900
     */
    sState_ExternVirtual(0x8037602C, dAcPy_c, Crouch);

    /*
     * initializeState: VT+0x2BC 0x80129DE0
     * executeState:    VT+0x2C0 0x80129FE0
     * finalizeState:   VT+0x2C4 0x80129EE0
     */
    sState_ExternVirtual(0x8037606C, dAcPy_c, SitJump);

    /*
     * initializeState: VT+0x2EC 0x8012AD30
     * executeState:    VT+0x2F0 0x8012ADC0
     * finalizeState:   VT+0x2F4 0x8012AD80
     */
    sState_ExternVirtual(0x803760AC, dAcPy_c, Slip);

    /*
     * initializeState: VT+0x2F8 0x8012D0C0
     * executeState:    VT+0x2FC 0x8012D390
     * finalizeState:   VT+0x300 0x8012D200
     */
    sState_ExternVirtual(0x803760EC, dAcPy_c, Turn);

    /*
     * initializeState: VT+0x304 0x80126950
     * executeState:    VT+0x308 0x801269E0
     * finalizeState:   VT+0x30C 0x801269A0
     */
    sState_ExternVirtual(0x8037612C, dAcPy_c, HipAttack);

    /*
     * initializeState: VT+0x310 0x80130220
     * executeState:    VT+0x314 0x80131F20
     * finalizeState:   VT+0x318 0x80132370
     */
    sState_ExternVirtual(0x8037616C, dAcPy_c, Swim);

    /*
     * initializeState: VT+0x340 0x80135010
     * executeState:    VT+0x344 0x80135E70
     * finalizeState:   VT+0x348 0x80135120
     */
    sState_ExternVirtual(0x803761AC, dAcPy_c, Kani);

    /*
     * initializeState: VT+0x34C 0x80139D90
     * executeState:    VT+0x350 0x8013A070
     * finalizeState:   VT+0x354 0x80139DD0
     */
    sState_ExternVirtual(0x803761EC, dAcPy_c, Cloud);

    /*
     * initializeState: VT+0x1EC 0x8013DC40
     * executeState:    VT+0x1F0 0x8013DD70
     * finalizeState:   VT+0x1F4 0x8013DD60
     */
